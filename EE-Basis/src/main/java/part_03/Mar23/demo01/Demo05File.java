...
public class Demo05File {
    ...
    private static void show02() {
        File f1 = new File("C:\\Users\\ZY\\Desktop\\aaa");
        boolean b1 = f1.mkdir();
        System.out.println("b1:" + b1);

        File f2 = new File("C:\\Users\\ZY\\Desktop\\111\\222\\333\\444");
        boolean b2 = f2.mkdirs();
        System.out.println("b2:" + b2);

        File f3 = new File("C:\\Users\\ZY\\Desktop\\abc.txt");
        boolean b3 = f3.mkdirs();//看类型,是一个文件
        System.out.println("b3:" + b3);

        File f4 = new File("C:\\Users\\ZY\\Desktop\\aaa");
        boolean b4 = f4.mkdirs();//不会抛出异常,路径存在,不会创建
